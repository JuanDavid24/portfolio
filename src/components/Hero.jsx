  ...
  return (
    <section id="hero" className="flex flex-col md:p-0 md:flex-row justify-center items-center text-balance">
      ...
      <div className="flex flex-col gap-6 lg:p-12 p-6 text-center md:mt-0 -mt-28">
        <h1 className="text-4xl text-balance font-bold font-sans">Hola, soy <span className="text-6xl align-text-bottom bg-gradient-to-r from-indigo-600 to-teal-500 bg-clip-text text-transparent tracking-wide opacity-75">Juan David</span></h1>
