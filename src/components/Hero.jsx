...
export function Hero() {
  return (
    <section id="hero" className="flex flex-col md:p-0 md:flex-row justify-center items-center mb-12 text-balance">
      ...
      <div className="flex flex-col gap-6 lg:p-12 p-6 text-center md:mt-0 -mt-28">
        <h1 className="text-4xl text-balance font-bold">Hola, soy <span className="text-indigo-500 text-6xl tracking-wide opacity-75">Juan David</span></h1>
